...
(query
  ...
  condition)
\end{lstlisting}
\todo[inline]{In webchurch, the condition is actually inside the condition function. So if, for example, you want to condition on \lstinline{x} being equal to 1, the last argument to your \lstinline{query} would be\lstinline{(condition (= x 1))}.}
