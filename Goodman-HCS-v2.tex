...
(define players-in-match ($\lambda$ (match) (apply append (map players-on-team (teams-in-match 'match1)))))
...
\todo[inline]{Erin: players don't currently play in matches, and these quantifiers assume players play in matches (not just teams). I can change played-in to check if the team was in the match OR the player was on a team that played in a match. Then this quantifier will work. Sound good?}
