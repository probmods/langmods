...
We assume that the set of possible compositions is sufficient to perform any syntactic operations needed.\footnote{\label{composition}Obvious choices for inclusion in the set of composition operators are forward and backward function application and composition:
\begin{itemize}
