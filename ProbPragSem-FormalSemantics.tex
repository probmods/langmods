...
\todo{here or somewhere need to discuss that compositionally in language and thought are similar but along different `directions'...}
...
\end{itemize}
\item ``Team 1 and Team 2 played in Match 1.''
\begin{itemize}
...
\begin{itemize}
\item ``Jim is the weakest player.''
\begin{itemize}
