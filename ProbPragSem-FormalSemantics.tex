...
This listener's exclusive preference for true interpretations leads to an extremely low values of the free variable (see ``Degree posterior'', dotted line). As a result the utterance conveys no information about the variable of interest: the strength posterior (dashed line) is equivalent ot the prior (solid line).}
\end{figure}
...
The use of a stochastic recursion to generate type ambiguities thus automatically enforces the preference for interpretation in lower types, a feature which is often stipulated in discussions of type-shifting \citep{parteerooth83,partee87}.
