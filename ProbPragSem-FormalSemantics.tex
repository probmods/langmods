...
\todo[inline]{Dan: Clean this composition stuff up (its just copied from previous footnotes). 
Also note a few effects of the process described: more type shifting is less a priori likely; constituents have distribution over static types.}
