...
plot(subj, type='l', col='red', ylim=c(0,1), xlab="Number of matches", ylab="Probability of reading", lwd=3, xaxt='n', lty=2)
axis(1, 1:10)
lines(obj, type='b', col='blue', lty=3, lwd=3)
legend('bottomleft', c("Subject wide scope", "Object wide scope"), text.col=c('red', 'blue'), lty=c(2,3), col=c('red', 'blue'))

plot(team.size, xaxt='n', col='black', ylim=c(1,6), xlab="Number of matches", ylab="Mean estimated team size", type='l')
lines(sws.team.size, col='red', lty=2)
lines(ows.team.size, col='blue', lty=3)
axis(1, 1:10)
legend('bottomleft', c("Marginal", "With subject wide scope", "With object wide scope"), text.col=c('black', 'red', 'blue'), lty=c(1,2,3), col=c('black', 'red', 'blue'))
