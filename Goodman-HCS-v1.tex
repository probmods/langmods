...
%Tenenbaum, etc}, 
and aspects of natural language \citep{bodetal03,chater06}. With a few localized exceptions \citep{adams75,cohen99b}, probabilistic tools have only recently been begun to be used widely in natural language semantics and pragmatics. In this chapter we synthesize several of these modeling advances, exploring a formal model of semantics grounded, via pragmatic inference, in conceptual structure.
