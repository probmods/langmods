...
%(define coin )
%\end{lstlisting}
Multiple calls to the function will result in a sequence of values which are not i.i.d., because the jointly depend on the unknown \lstinline{bias} (though they are exchangeable \citep{de1993probabilita}).
